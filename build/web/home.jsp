<%-- 
    Document   : home
    Created on : Oct 25, 2023, 12:58:02 PM
    Author     : Tosaka
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid pt-5">
            ...
            <div class="row px-xl-5 pb-3">
                <c:forEach items="${requestScope.listTrandyProduct}" var="item">
                    <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
        ...
        <div class="container-fluid pt-5">
            ...
            <div class="row px-xl-5 pb-3">
                <c:forEach items="${requestScope.listNewestProduct}" var="item">
                    <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="${item.getProductImage()}" alt="">
        ...
        <script>
            function buy(productID) {
                ...
                window.location.href="homecartcontroller?productID="+productID+"&num="+num;  
            }
        </script>
